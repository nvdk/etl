...
import com.linkedpipes.etl.executor.unpacker.model.template.TemplatePort;
...
class JarExpander {
    ...
    public ExecutorComponent expand(
            ...
            JarTemplate template) throws ExecutorException {
    ...
    private void mergeConfigurations(
            ...
            List<String> configurations) throws ExecutorException {
